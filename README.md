...
|----|------------------|------|------|----------|----------|--------------|--------|
| A | 자릿값 | 10 | 8 | 80% | 5분 | 김상홍 | 박정현 |
| F | 당신은 한 번만 봅니다 | 0 | 0 | 0% | - | - | 윤상건 |
| E | 열등고등학교 | 9 | 2 | 22% | 100분 | 김상홍 | 박정현 |
| B | 게임 서버 | 18 | 0 | 0% | - | - | 박정현 |
| C | 사다리 타기 | 0 | 0 | 0% | - | - | 박정현 |
| K | 2xN 타일링? | 0 | 0 | 0% | - | - | 서형빈 |
| D | 통나무 자르기 | 0 | 0 | 0% | - | - | 박정현 |
| H | 석탄 나르기 | 0 | 0 | 0% | - | - | 허준영 |
| G | 유한 힐베르트 호텔 | 9 | 0 | 0% | - | - | 윤상건 |
| J | XYZ | 1 | 0 | 0% | - | - | 장병준 |
| I | 플랫랜드2: 전쟁의 시작 | 0 | 0 | 0% | - | - | 윤상건 |

- Open Contest

| 난이도순 | 문제이름         | 제출 | 정답 | 정답비율 | 풀린시간 | First Solver | 출제자 |
|----|------------------|------|------|----------|----------|--------------|--------|
| A | 자릿값 | 5 | 5 | 100% | 18분 | 채원찬 | 박정현 |
| F | 당신은 한 번만 봅니다 | 0 | 0 | 0% | - | - | 윤상건 |
| E | 열등고등학교 | 3 | 2 | 67% | 309분 | 한창훈 | 박정현 |
| B | 게임 서버 | 15 | 2 | 13% | 244분 | 한창훈 | 박정현 |
| C | 사다리 타기 | 6 | 3 | 50% | 278분 | 한창훈 | 박정현 |
| K | 2xN 타일링? | 1 | 1 | 100% | 658분 | 한창훈 | 서형빈 |
| D | 통나무 자르기 | 5 | 0 | 0% | - | - | 박정현 |
| H | 석탄 나르기 | 0 | 0 | 0% | - | - | 허준영 |
| G | 유한 힐베르트 호텔 | 0 | 0 | 0% | - | - | 윤상건 |
| J | XYZ | 0 | 0 | 0% | - | - | 장병준 |
| I | 플랫랜드2: 전쟁의 시작 | 0 | 0 | 0% | - | - | 윤상건 |
